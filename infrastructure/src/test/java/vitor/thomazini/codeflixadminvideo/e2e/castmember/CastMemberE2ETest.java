package vitor.thomazini.codeflixadminvideo.e2e.castmember;
...
public class CastMemberE2ETest implements MockDsl {
    ...
    void asACatalogAdminIShouldBeAbleToCreateANewCastMemberWithValidValues() throws Exception {
        ...
        final var actualMember = castMemberRepository.findById(actualMemberId.value()).get();
    ...
    public void asACatalogAdminIShouldBeAbleToDeleteACastMemberByItsIdentifier() throws Exception {
        ...
        Assertions.assertFalse(castMemberRepository.existsById(actualId.value()));
    }
