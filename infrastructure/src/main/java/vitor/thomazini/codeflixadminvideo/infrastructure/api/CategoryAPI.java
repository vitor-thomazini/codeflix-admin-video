...
public interface CategoryAPI {
    ...
    Pagination<CategoryListApiOutput> listCategories(
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Created retrieved successfully"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Created updated successfully"),
            @ApiResponse(responseCode = "404", description = "Category was not found"),
            @ApiResponse(responseCode = "500", description = "An internal server error was thrown")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Created deleted successfully"),
            @ApiResponse(responseCode = "500", description = "An internal server error was thrown")
    })
